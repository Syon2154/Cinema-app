...
public class ShoppingCartDaoImpl implements ShoppingCartDao {
    ...
    public ShoppingCart add(ShoppingCart shoppingCart) {
        ...
        try {
            ...
            throw new DataProcessingException("Can't insert a shopping cart: " + shoppingCart, ex);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public ShoppingCart getByUser(User user) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            throw new DataProcessingException("Can't find a shopping cart by user: " + user, ex);
        }
    }
    ...
    public void update(ShoppingCart shoppingCart) {
        ...
        try {
            ...
            throw new DataProcessingException("Can't update a shopping cart: " + shoppingCart, ex);
        } finally {
            if (session != null) {
                session.close();
            }
