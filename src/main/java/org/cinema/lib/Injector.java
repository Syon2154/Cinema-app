...
public class Injector {
    ...
    private Injector(String mainPackageName) {
        try {
            ...
            throw new RuntimeException("Can't get information about all classes", ex);
        }
    }
    ...
    private Object createInstance(Class<?> clazz) {
        ...
        try {
            ...
            throw new RuntimeException("Can't create object of the class", ex);
        }
        return newInstance;
    }
    ...
    private void setValueToField(Field field, Object instanceOfClass, Object classToInject) {
        try {
            ...
            throw new RuntimeException("Can't set value to field ", ex);
        }
    }
    /**
